...
- в строке 7–11 слогов; строки одной секции не расходятся по длине больше чем на 2 слога;
- никогда не начинай куплет с «Ты помнишь как», «Был тот день», «Помню я», «Там где», «Когда-то»: это первые признаки шаблонного AI-текста;
...
- запрещены избитые пары: «любовь/вновь», «мечты/ты», «душа/хороша», «глаза/слеза», «счастья/ненастья» — только если образ реально свежий;
...
"верь в мечту", "дорога судьбы", "огонь в груди", "все преграды позади", "лети к звёздам",
"звёзды светят нам", "вместе навсегда", "лучший в мире", "особенный момент", "я верю в тебя",
"сила любви", "ты моё всё", "жизнь прекрасна", "мы победим", "иди вперёд не останавливайся".
...
Что должна делать каждая секция:
- Verse 1: начни с действия, ощущения или короткого диалога — не с «ты помнишь» и не с описания;
- Pre-Chorus: 2-4 строки нарастания, незакрытая мысль, ведущая к припеву;
- Chorus: один хук 4-8 слов, одна эмоция, понятен без контекста;
- Verse 2: другой угол — значение этого сегодня, не повтор Verse 1;
- Bridge: признание или поворот, которого раньше не было прямо сказано.

Техника:
- не повторяй бриф дословно чаще одного раза;
- добавь один конкретный образ без новых выдуманных фактов: голос, кухня, вечер, фото, дорога;
- рифмы разговорные и звучащие; запрещены: любовь/вновь, мечты/ты, счастья/ненастья без нового образа;
- перевёрнутый порядок слов ради рифмы запрещён.
